...
public class otpscreensignup extends AppCompatActivity {
    ...
    DatabaseReference profileref = database_profile.getReference("Owner_Users");
    EditText namebox;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.otpscreensignup);
                ...
                .addOnCompleteListener(otpscreensignup.this, new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        if (task.isSuccessful()) {
                            ...
                            //verification successful we will start the profilefragment activity
